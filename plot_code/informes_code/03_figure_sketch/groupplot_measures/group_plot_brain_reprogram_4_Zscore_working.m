...
analysisref = 'new4_group19_dolor_n5'; % new4_group19_dolor_n5 new4_group16_chorrito_n3  new4_group20_3intens MANUALLY SET!!! extra info for the name. Set group matching  the rows of 'groupplot' selected in;   for suji  =  [1 3 4 9] lateral_group7_RECOV
...
for suji  = 12 %makeRow(sel_subjects) %1:size(groupplot,1) SELECT included fish+condition
    ...
    if plotmaps
        ...
        % HACKING SNIPPET !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%         warning('HACKED TO SEE NEGATIVE VALUES')
%         cclim = [-3 4];
...
if getR
    ...
    labels = {'id' 'roi' 'roi n' 'cond' 'peak' 'wmean' 'slope' 'onsetlat' 'Zpeak' 'Zmean' 'Zslope' 'peaklat' 'hemis', 'roii'};
