...
thresh_mode = 'moviebased_thresh_max'; % 'moviebased_thresh_max' 'wavebased_thresh_max' 'wavebased_thresh_local' 'manual'. 'moviebased_thresh_max' is the one we have been using for tiles
...
% selroinames = {'dm4m_R2',  'dm2_R2' ,'dm1_R', 'dldm_R'};%dm3 % FROM '03figure_sketch'

% selroinames = {'dm4m_R3',  'dm2_R3' ,'dm1_R', 'dldm_R'};%dm3
...
%         cmap_tile = colormap_loadBV2(256); 
    ...
    if plotwaves
        ...
        savename= ['WAVES' num2str(VSDI.ref) movie_ref '_cond' num2str(condi) '_rej'  num2str(reject_on) '_' num2str(numel(sel_trials)) 'trials_' wave_units '_thresh' num2str(round(tileset.thresh(2),1))];
        else 
