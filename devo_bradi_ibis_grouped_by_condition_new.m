...
excelname = fullfile(outfolder,[outfield ref_movie '_brady_grouped_bycondition_2.xlsx']);
excelname2 =  fullfile(outfolder,[outfield ref_movie '_TESTnew1_brady_trialiwise.xlsx']);
...
if export.excel_indiv == 1
    ...
    writecell (paramet, excelname2, 'sheet', ['param' num2str(VSDI.ref)])
    
    writecell(outputcell, excelname2, 'sheet', num2str(VSDI.ref))
...
% -----------------------------------------------------------
if IBI == 0
brady = output(seltrials, 14);
elseif IBI==1
brady = output(seltrials, 15);
end 
...
name1 = ['SHARKvsnoSHARK_' num2str(VSDI.ref), '_', num2str(cond_codes(1)), 'ibi', num2str(IBI), '_', whattrials, '_reject', num2str(reject_on),'_', side, '_BRADI.jpg' ];
...
name2 = ['SHARKvsnoSHARK_' num2str(VSDI.ref), '_', num2str(cond_codes(1)), 'ibi', num2str(IBI), '_', whattrials, '_reject', num2str(reject_on),'_', side, '.jpg' ];
