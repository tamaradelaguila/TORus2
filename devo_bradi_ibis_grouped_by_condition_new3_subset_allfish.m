...
group_note = 'selection_roi1_with0_dm2';  % to avoid overriding excel if a new group is loaded

for rowi = 1:4%size(groupbrady,1)
    ...
    excelname_i = fullfile(outfolder,['BRADYnew3_individ_' outfield ref_movie  '_' dataunits '_' whattrials '_' group_note '.xlsx']);
    excelname_g =  fullfile(outfolder,['BRADYnew3_grouped_' outfield ref_movie '_' dataunits '_' whattrials '_' group_note '.xlsx']);
...
clearvars -except groupbrady  whattrials  outfield dataunits  save2plot group_note
end
