...
source.in = '/home/tamara/Documents/MATLAB/VSDI/TORus/data/bradi/correlacion'; 
source.out = '/home/tamara/Documents/MATLAB/VSDI/TORus/data/bradi/correlacion'; 
source.filelist= 'INPUT_filelist.txt';

design.RO = 1; %1 = with RO, 0= no RO. Will influence in whether trying to find blanks or not
design.kind = 'single_stim'; %'single_stim', 'discrim'

% RASTER SETTINGS: 'none', 'match_ibis', 'match_beats', 'custom'
% .......................................................................
config.rasterplot = 'custom';
...
for fili = 1:size(ref.filelist,1)
    ...
    excelname = fullfile(source.out, ['corr01_BRADY_fromSpike_' file(1:end-4) '.xls']);
...
%             %  SENSOR PEAK
%             % ..............................
%             output{rowi,16} = round(peakS,2); %percentage of brady from inst freq ( >0 means brady)
...
%         header = {'stim(s)' 'n' 'CS' 'us' 'incl' '' 'npre' 'npost' 'npost_adj' '%beats' '' 'ibipre' labelibi.comp '%ibi' '' 'peakS'};
        header = {'stim(s)' 'n' 'CS' 'us' 'incl' 'BVtrial' 'npre' 'npost' 'npost_adj' '%beats' '' 'ibipre' labelibi.comp '%ibi'};
