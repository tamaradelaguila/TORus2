...
%% MATCH STEP 3 (OPTION 1 AUTOMATIC) - MATCHING PROCESS ITSELF
% ....................................................................
...
%% MATCH STEP 3 (OPTION2 - MANUAL FROM EXCEL) - MATCHING PROCESS ITSELF
% ....................................................................
% Simply input the matching correspondence from external excel containing,
% in two columns: (1) spiketime ('stim' name) and (2) trial number
% ('trial') together with columns corresponding to brady measures. 
% NOTE about names: 'stim' and 'trials' need to have fixed names, unlike
% the rest, whose name will be retrieve in the code

source.in = '/home/tamara/Documents/MATLAB/VSDI/TORus/data/dataspike/excels_brady'; 
source.filelist= '220611spike_BRADYcodeinput.csv';
...
for ii = 1: length(bradydata)
    ...
    if isempty(bradydata(ii).idx ) % it's important to fill the [] with NaN to avoid errors when using 'find([bradydata(ii).idx] == value)'
