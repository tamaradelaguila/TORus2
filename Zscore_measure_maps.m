...
clear
% load('/home/tamara/Documents/MATLAB/VSDI/MOT/plot/informes/03_figure_sketch/groupplot_measures/groupplot.mat')
load('/home/tamara/Documents/MATLAB/VSDI/MOT/plot/informes/03_figure_sketch/groupplot_measures/groupplot_new.mat') % ATTENTION: select cases manually (there are repetitions)
...
ref_movie= '_04diff_f0pre';% '_17filt5' ; '_18filt6'
% ref_movie= '_12filt5' ;
...
savein = '/home/tamara/Documents/MATLAB/VSDI/MOT/plot/informes/03_figure_sketch/groupplot_measures/Zscore' ;%@ SET
...
% USER SETTINGS
path.rootpath = '/home/tamara/Documents/MATLAB/VSDI/MOT'; %@ SET for each experiment
...
%         end % for condition
        ...
        if plotmaps
            ...
            for condition =  makeRow(cond)
                ...
                condidx = find(VSDI.condition(:,1) ==condition); % get idx from condition
                tempmA = VSDI.condition(condidx(1),4); %get mA from first trial that meet the condition
                title(VSDI.conditionlabel{condition+1,2})
            ...
            sgtitle([num2str(VSDI.ref), 'rej' , num2str(reject_on), '(',ref_movie(2:end),  ')', 'Zmap. up: peak; down: onsetA' VSDI.conditionlabel{condition+1,2}])
